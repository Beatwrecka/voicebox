...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'neu-inset inline-flex h-11 items-center justify-center rounded-2xl p-1 text-muted-foreground',
      className,
    )}
    {...props}
  />
